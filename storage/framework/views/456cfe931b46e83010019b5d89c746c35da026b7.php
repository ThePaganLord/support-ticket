...
<?php $component->withAttributes([]); ?>
    <div class="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8">
        <form method="POST" action="<?php echo e(route('tickets.update', $ticket)); ?>">
            ...
            ><?php echo e(old('message', $ticket->message)); ?></textarea>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
                <a href="<?php echo e(route('tickets.index')); ?>"><?php echo e(__('Cancel')); ?></a>
            </div>
        </form>
    </div>
 <?php echo $__env->renderComponent(); ?>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\Laravel\testthis\resources\views/tickets/edit.blade.php ENDPATH**/ ?>